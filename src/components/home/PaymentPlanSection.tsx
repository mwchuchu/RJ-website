...
interface PaymentPlanSectionProps {
  ...
  onlyPieChart?: boolean;
}

export const PaymentPlanSection: React.FC<PaymentPlanSectionProps> = ({ onNavigate, hideExploreButton = false, onlyPieChart = false }) => {
